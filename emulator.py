...
class Server(object):
    ...
    def handle_login(self, params, serverport):
        motd  = "Welcome to Yuvi's server!\r\n"
        motd += "Server is dedicated to the preservation of DeS Online.\r\n"
        motd += "Follow Discord.gg/cCSgv4m for more info\r\n"
        ...
        motd3  = "User Selectable World Tendency is Live!\r\n"
        motd3 += "Visit TheArchstones.com or Discord for info\r\n"
